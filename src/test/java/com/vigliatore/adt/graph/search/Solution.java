...
public class Solution {
  ...
  public Solution(InputStream in) throws IOException {
    ...
    startNode = Integer.parseInt(reader.readLine());
  }
  ...
  public int solve() {
    PrimsMinimumSpanningTree mst = new PrimsMinimumSpanningTree(graph, startNode);
    mst.solve();
